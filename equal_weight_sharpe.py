...
def calculate_portfolio_returns(data_train, tickers):
    ...
    """
    tickers_list = tickers.split()  # Ensures we have a list of tickers from a string
...
def calculate_sharpe_ratio(portfolio_returns, risk_free_rate=0):
    ...
    Parameters:
    - portfolio_returns (Series): A pandas Series of portfolio returns. It can be obtained from calculate_portfolio_returns function
